# BD8316GWL-EVK-101 Design Resource Repository
* Hardware Design Files and Documentation for the ROHM BD8316GWL-EVK-101 EVK

----
### Description: 
* The BD8316GWL is step-up and inverted 2-channel switching regulator with integrated internal high-side MOSFET 
* With wide input range from 2.5~5.5V ,it suitable for application of portable item 
* In addition, The small package design is ideal for miniaturizing the power supply

----
### Repository Contents
* Design Files: Contains Schematic and BOM information for this EVK Board
* Measurement Reports Folder: Contains measurement testing information completed for these EVK Boards

----
### Where to Purchase?
* http://www.rohm.com/web/global/distribution/-/dinventory/BD8316GWL-E2/sample/1
